...
private:
  enum class Operation { none, scan, install, uninstall };
   void start_scan(bool force=false, bool clear_notice=true); void render_items(); void apply_filter(bool scroll_top=false); void poll_worker(); void update_actions();
  ...
  Microsoft::UI::Xaml::DispatcherTimer timer_{nullptr}, search_timer_{nullptr}; winrt::event_token timer_token_{}, search_timer_token_{}, refresh_token_{}; Operation operation_{Operation::none}; bool ui_ready_{};
}; }
