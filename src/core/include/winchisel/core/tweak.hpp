...
// whole lifetime of the introducing release (e.g. 1.1.0) and disappear with
// the next one (e.g. 1.1.0) without touching this list.
inline constexpr std::string_view k_new_tweaks_version{"1.1.0"};
