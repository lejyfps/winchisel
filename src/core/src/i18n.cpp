...
std::unordered_map<std::wstring, std::wstring> const& german() {
    static const std::unordered_map<std::wstring, std::wstring> table{
        ...
        {L"Measure transfer cadence", L"Transfer-Kadenz messen"},
        {L"Measuring...", L"Messe..."},
        {L"Measuring USB transfer cadence...", L"USB-Transfer-Kadenz wird gemessen..."},
        {L"Capturing USB transfer cadence for 7 seconds. Use your devices meanwhile. This does not change any system setting.", L"USB-Transfer-Kadenz wird 7 Sekunden erfasst. Geräte dabei benutzen. Es wird keine Systemeinstellung geändert."},
        {L"Cadence measurement complete", L"Kadenzmessung abgeschlossen"},
        {L"Cadence measurement failed", L"Kadenzmessung fehlgeschlagen"},
        {L"Resolving hardware context...", L"Hardware-Kontext wird ermittelt..."},
        {L"Cancelling...", L"Wird abgebrochen..."},
        {L"Exported: ", L"Exportiert: "},
        {L"Ready", L"Bereit"},
        ...
        {L"New", L"Neu"},
        {L"Startup Manager", L"Autostart-Manager"},
        {L"Scheduled Tasks", L"Geplante Aufgaben"},
        {L"Search scheduled tasks", L"Geplante Aufgaben suchen"},
        {L"Loading scheduled tasks...", L"Geplante Aufgaben werden geladen..."},
        {L"scheduled tasks", L"Geplante Aufgaben"},
        ...
        {L"Sort by", L"Sortieren nach"},
        {L"Name", L"Name"},
        {L"Status", L"Status"},
        {L"Path", L"Pfad"},
        {L"Hide Microsoft entries", L"Microsoft-Einträge ausblenden"},
        {L"Safe", L"Sicher"},
        ...
        {L"Active", L"Aktiv"},
        {L"User", L"Benutzer"},
        {L"Cleanup", L"Bereinigung"},
        {L"Scan cleanup categories", L"Bereinigungskategorien scannen"},
        {L"Scanning cleanup categories...", L"Bereinigungskategorien werden gescannt..."},
        {L"Clean selected", L"Ausgewählte bereinigen"},
        {L"Restart as administrator", L"Als Administrator neu starten"},
        {L"Temporary files", L"Temporäre Dateien"},
        {L"Your personal temp folder. Safe to empty; apps recreate what they need.", L"Dein persönlicher Temp-Ordner. Kann bedenkenlos geleert werden; Apps legen neu an, was sie brauchen."},
        {L"Windows temporary files", L"Temporäre Windows-Dateien"},
        {L"System-wide temp folder. Files in use are skipped.", L"Systemweiter Temp-Ordner. Verwendete Dateien werden übersprungen."},
        {L"Recycle Bin", L"Papierkorb"},
        {L"Empties the recycle bin on all drives.", L"Leert den Papierkorb auf allen Laufwerken."},
        {L"Thumbnails", L"Miniaturansichten"},
        {L"Explorer thumbnail and icon caches. Rebuilt automatically; entries may be locked while Explorer runs.", L"Explorer-Miniatur- und Symbol-Caches. Werden automatisch neu aufgebaut; Einträge können bei laufendem Explorer gesperrt sein."},
        {L"Delivery Optimization", L"Übermittlungsoptimierung"},
        {L"Update payloads shared with other PCs. Locked files are skipped.", L"Für andere PCs freigegebene Update-Pakete. Gesperrte Dateien werden übersprungen."},
        {L"Shader caches", L"Shader-Caches"},
        {L"GPU shader caches. Rebuilt on demand; one short stutter may follow.", L"GPU-Shader-Caches. Werden bei Bedarf neu aufgebaut; danach kann es einmal kurz ruckeln."},
        {L"Windows Update cleanup", L"Windows-Update-Bereinigung"},
        {L"Runs DISM component cleanup. Takes a while; nothing is uninstalled. Needs administrator rights.", L"Führt die DISM-Komponentenbereinigung aus. Dauert eine Weile; nichts wird deinstalliert. Benötigt Administratorrechte."},
        {L"Previous installations", L"Vorherige Installationen"},
        {L"Removes Windows.old and setup leftovers. You lose the rollback option. Needs administrator rights.", L"Entfernt Windows.old und Setup-Reste. Die Rückkehroption entfällt. Benötigt Administratorrechte."},
        {L"Prefetch", L"Prefetch"},
        {L"Removes prefetch traces (the folder itself stays). Frees little; Windows rebuilds it. Needs administrator rights.", L"Entfernt Prefetch-Spuren (der Ordner selbst bleibt). Bringt wenig; Windows baut sie neu auf. Benötigt Administratorrechte."},
        {L"Requires administrator", L"Benötigt Administratorrechte"},
        {L"Restart Winchisel as administrator to enable the system categories.", L"Winchisel als Administrator neu starten, um die Systemkategorien zu aktivieren."},
        {L"Runs DISM; size is determined during cleanup.", L"Führt DISM aus; die Größe steht erst bei der Bereinigung fest."},
        {L"Nothing selected.", L"Nichts ausgewählt."},
        {L"Clean selected categories?", L"Ausgewählte Kategorien bereinigen?"},
        {L"This permanently deletes the selected files. Removing previous installations also removes the Windows rollback option.", L"Dies löscht die ausgewählten Dateien endgültig. Das Entfernen vorheriger Installationen entfernt auch die Windows-Rückkehroption."},
        {L"Cleanup finished.", L"Bereinigung abgeschlossen."},
        {L"Cleanup failed.", L"Bereinigung fehlgeschlagen."},
        {L"Cleanup was cancelled.", L"Bereinigung wurde abgebrochen."},
        {L"Cancelling...", L"Wird abgebrochen..."},
        {L"Cleaning...", L"Wird bereinigt..."},
        {L"Reclaimable:", L"Freizugeben:"},
        {L"freed", L"freigegeben"},
        {L"files removed", L"Dateien entfernt"},
