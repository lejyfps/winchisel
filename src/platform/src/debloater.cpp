...
winchisel::core::Result<CommandResult> run_native(std::wstring command){auto [waited,output]=detail::run_captured(std::move(command));return CommandResult{waited.exit_code,waited.timed_out,std::move(output)};}
